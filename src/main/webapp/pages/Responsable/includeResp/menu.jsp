	...
	<div>
		<div >
			<ul class="nav nav-tabs nav-stacked menu2 w3-card-12"> 
				...
				<li><a href="/ServiceEE/pages/Responsable/Profil.jsp" class="w3-margin" >Mes Informations</a></li>
...
<s:hidden>
<form action="goToRendezVousResponsable" id="formRendezVous" >


</form>
<form action="goToEntretienResponsable" id="formEntretien">
